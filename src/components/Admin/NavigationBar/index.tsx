          ...
          return (
            <li key={step.path}>
              <Link
                ...
                className={`flex items-center gap-2 px-5 py-3 border border-[#E0E0E0] dark:bg-[#12101D] rounded-xl drop-shadow-custom-black
                  ${isActive
