...
export default function NavigationBar() {
  ...
  const [active, setActive] = useState({
    dadosImoveis: false,
    endereco: false,
    valoresCondicoes: false,
    mideas: false,
  });

  useEffect(() => {
    setActive({
      dadosImoveis: pathname === '/dashboard/imoveis/cadastrar/dados-imovel',
      endereco: pathname === '/dashboard/imoveis/cadastrar/endereco',
      valoresCondicoes: pathname === '/dashboard/imoveis/cadastrar/valores-condicoes',
      mideas: pathname === '/dashboard/imoveis/cadastrar/mideas',
    });
  }, [pathname]);
  return (
    <div className="flex border-b-2 pb-6 border-[#11111180]">
      <ul className="flex items-center gap-3 flex-wrap">
        <li>
          <Link
            href={"/dashboard/imoveis/cadastrar/dados-imovel"}
            className={getLinkClass(active.dadosImoveis)}>
            <svg
              width="22"
              height="20"
              viewBox="0 0 22 20"
              ...
              <path
                ...
                fill={active.dadosImoveis ? '#fff' : '#666'}
              />
            </svg>
            <p
              className={`text-[18px] font-medium ${poppinsFont.className}`}>
              Dados do Imóvel
            </p>
          </Link>
        </li>
        ...
        <li>
          <Link
            href={"/dashboard/imoveis/cadastrar/endereco"}
            className={getLinkClass(active.endereco)}>
            <svg
              width="16"
              height="20"
              viewBox="0 0 16 20"
        ...
        <li>
          <Link
            href={"/dashboard/imoveis/cadastrar/valores-condicoes"}
            className={getLinkClass(active.valoresCondicoes)}>
            <svg
              width="10"
              height="18"
              viewBox="0 0 10 18"
        ...
        <li>
          <Link
            href={"/dashboard/imoveis/cadastrar/mideas"}
            className={getLinkClass(active.mideas)}>
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
              ...
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M7 12H17L13.55 7.5L11.25 10.5L9.7 8.5L7 12ZM6 16C5.45 16 4.97917 15.8042 4.5875 15.4125C4.19583 15.0208 4 14.55 4 14V2C4 1.45 4.19583 0.979167 4.5875 0.5875C4.97917 0.195833 5.45 0 6 0H18C18.55 0 19.0208 0.195833 19.4125 0.5875C19.8042 0.979167 20 1.45 20 2V14C20 14.55 19.8042 15.0208 19.4125 15.4125C19.0208 15.8042 18.55 16 18 16H6ZM6 14H18V2H6V14ZM2 20C1.45 20 0.979167 19.8042 0.5875 19.4125C0.195833 19.0208 0 18.55 0 18V4H2V18H16V20H2Z"
                fill={active.mideas ? '#fff' : '#666'}
              />
            </svg>
